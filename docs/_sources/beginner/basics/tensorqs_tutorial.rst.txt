.. note::
    ...
    Click :ref:`here <sphx_glr_download_beginner_basics_tensorqs_tutorial.py>` to download the full example code
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Random Tensor: 
     tensor([[0.5482, 0.1905, 0.1076],
            [0.8601, 0.2083, 0.7705]]) 
