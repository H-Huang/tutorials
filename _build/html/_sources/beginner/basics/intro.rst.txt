.. note::
    ...
    Click :ref:`here <sphx_glr_download_beginner_basics_intro.py>` to download the full example code
.. rst-class:: sphx-glr-example-title

.. _sphx_glr_beginner_basics_intro.py:
...
.. _sphx_glr_download_beginner_basics_intro.py:
