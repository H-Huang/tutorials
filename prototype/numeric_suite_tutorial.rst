...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    layer2.0.conv2.weight tensor(28.8232)
    layer2.0.downsample.0.weight tensor(31.5558)
    layer2.1.conv1.weight tensor(30.7667)
    layer2.1.conv2.weight tensor(28.4515)
    layer3.0.conv1.weight tensor(30.9245)
    layer3.0.conv2.weight tensor(26.6835)
    layer3.0.downsample.0.weight tensor(28.7825)
    layer3.1.conv1.weight tensor(28.9701)
    layer3.1.conv2.weight tensor(25.6780)
    layer4.0.conv1.weight tensor(26.8488)
    layer4.0.conv2.weight tensor(25.8353)
    layer4.0.downsample.0.weight tensor(28.6354)
    layer4.1.conv1.weight tensor(26.8727)
    layer4.1.conv2.weight tensor(28.4300)
    fc._packed_params._packed_params tensor(32.6502)
...
.. image:: /prototype/images/sphx_glr_numeric_suite_tutorial_001.png
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    conv1.stats tensor(37.1524, grad_fn=<MulBackward0>)
    layer1.0.conv1.stats tensor(29.7778, grad_fn=<MulBackward0>)
    layer1.0.conv2.stats tensor(28.7380, grad_fn=<MulBackward0>)
    layer1.0.add_relu.stats tensor(32.2532, grad_fn=<MulBackward0>)
    layer1.1.conv1.stats tensor(29.6883, grad_fn=<MulBackward0>)
    layer1.1.conv2.stats tensor(25.2945, grad_fn=<MulBackward0>)
    layer1.1.add_relu.stats tensor(29.3342, grad_fn=<MulBackward0>)
    layer2.0.conv1.stats tensor(26.4813, grad_fn=<MulBackward0>)
    layer2.0.conv2.stats tensor(26.5018, grad_fn=<MulBackward0>)
    layer2.0.downsample.0.stats tensor(21.8761, grad_fn=<MulBackward0>)
    layer2.0.add_relu.stats tensor(25.5013, grad_fn=<MulBackward0>)
    layer2.1.conv1.stats tensor(25.3366, grad_fn=<MulBackward0>)
    layer2.1.conv2.stats tensor(24.2103, grad_fn=<MulBackward0>)
    layer2.1.add_relu.stats tensor(25.8032, grad_fn=<MulBackward0>)
    layer3.0.conv1.stats tensor(26.9472, grad_fn=<MulBackward0>)
    layer3.0.conv2.stats tensor(26.2601, grad_fn=<MulBackward0>)
    layer3.0.downsample.0.stats tensor(25.0421, grad_fn=<MulBackward0>)
    layer3.0.add_relu.stats tensor(24.4599, grad_fn=<MulBackward0>)
    layer3.1.conv1.stats tensor(30.9216, grad_fn=<MulBackward0>)
    layer3.1.conv2.stats tensor(26.2847, grad_fn=<MulBackward0>)
    layer3.1.add_relu.stats tensor(25.0038, grad_fn=<MulBackward0>)
    layer4.0.conv1.stats tensor(26.9593, grad_fn=<MulBackward0>)
    layer4.0.conv2.stats tensor(27.1351, grad_fn=<MulBackward0>)
    layer4.0.downsample.0.stats tensor(21.8130, grad_fn=<MulBackward0>)
    layer4.0.add_relu.stats tensor(20.3088, grad_fn=<MulBackward0>)
    layer4.1.conv1.stats tensor(26.1822, grad_fn=<MulBackward0>)
    layer4.1.conv2.stats tensor(18.3646, grad_fn=<MulBackward0>)
    layer4.1.add_relu.stats tensor(18.3262, grad_fn=<MulBackward0>)
    fc.stats tensor(20.8483, grad_fn=<MulBackward0>)
    quant.stats tensor(48.3905)
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    layer1.0.stats tensor(32.9167)
    layer1.1.stats tensor(33.6386)
    layer2.0.stats tensor(29.1493)
    layer2.1.stats tensor(31.1019)
    layer3.0.stats tensor(28.9748)
    layer3.1.stats tensor(31.8633)
    layer4.0.stats tensor(25.7577)
    layer4.1.stats tensor(23.2475)
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    rnn._all_weight_values.0.param tensor(48.1138)
    rnn._all_weight_values.1.param tensor(48.1267)
    rnn._all_weight_values.2.param tensor(48.1291)
    rnn._all_weight_values.3.param tensor(48.1424)
    rnn._all_weight_values.4.param tensor(48.1207)
    decoder._packed_params._packed_params tensor(47.9553)
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    rnn.stats tensor(55.3579, grad_fn=<MulBackward0>)
    decoder.stats tensor(36.8216, grad_fn=<MulBackward0>)
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    rnn.stats tensor(56.1942)
    decoder.stats tensor(37.1442)
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** ( 34 minutes  38.554 seconds)
