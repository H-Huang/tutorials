 ...
 .. code-block:: none
    ...
    scripted_searcher graph:
     graph(%self : __torch__.GreedySearchDecoder,
      ...
      %42 : bool = prim::Constant[value=1]() # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/deploy_seq2seq_hybrid_frontend_tutorial.py:566:8
      %21 : None = prim::Constant()
      %18 : int = prim::Constant[value=4]() # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/deploy_seq2seq_hybrid_frontend_tutorial.py:561:68
      %17 : Device = prim::Constant[value="cpu"]() # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/deploy_seq2seq_hybrid_frontend_tutorial.py:561:48
      %12 : int = prim::Constant[value=2]() # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/deploy_seq2seq_hybrid_frontend_tutorial.py:559:41
      %16 : int = prim::Constant[value=1]() # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/deploy_seq2seq_hybrid_frontend_tutorial.py:561:35
      %26 : int = prim::Constant[value=0]() # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/deploy_seq2seq_hybrid_frontend_tutorial.py:563:34
      %4 : __torch__.EncoderRNN = prim::GetAttr[name="encoder"](%self)
      %7 : (Tensor, Tensor) = prim::CallMethod[name="forward"](%4, %input_seq.1, %input_length.1) # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/deploy_seq2seq_hybrid_frontend_tutorial.py:557:42
      %encoder_outputs.1 : Tensor, %encoder_hidden.1 : Tensor = prim::TupleUnpack(%7)
      %decoder_hidden.1 : Tensor = aten::slice(%encoder_hidden.1, %26, %26, %12, %16) # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/deploy_seq2seq_hybrid_frontend_tutorial.py:559:25
      %20 : int[] = prim::ListConstruct(%16, %16)
      %23 : Tensor = aten::ones(%20, %18, %21, %17, %21) # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/deploy_seq2seq_hybrid_frontend_tutorial.py:561:24
      %decoder_input.1 : Tensor = aten::mul(%23, %16) # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/deploy_seq2seq_hybrid_frontend_tutorial.py:561:24
      %27 : int[] = prim::ListConstruct(%26)
      %all_tokens.1 : Tensor = aten::zeros(%27, %18, %21, %17, %21) # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/deploy_seq2seq_hybrid_frontend_tutorial.py:563:21
      %33 : int[] = prim::ListConstruct(%26)
      %all_scores.1 : Tensor = aten::zeros(%33, %21, %21, %17, %21) # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/deploy_seq2seq_hybrid_frontend_tutorial.py:564:21
      %all_tokens : Tensor, %all_scores : Tensor, %decoder_hidden : Tensor, %decoder_input : Tensor = prim::Loop(%max_length.1, %42, %all_tokens.1, %all_scores.1, %decoder_hidden.1, %decoder_input.1) # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/deploy_seq2seq_hybrid_frontend_tutorial.py:566:8
        block0(%43 : int, %all_tokens.6 : Tensor, %all_scores.6 : Tensor, %decoder_hidden.5 : Tensor, %decoder_input.9 : Tensor):
          %44 : __torch__.LuongAttnDecoderRNN = prim::GetAttr[name="decoder"](%self)
          %48 : (Tensor, Tensor) = prim::CallMethod[name="forward"](%44, %decoder_input.9, %decoder_hidden.5, %encoder_outputs.1) # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/deploy_seq2seq_hybrid_frontend_tutorial.py:568:45
          %decoder_output.1 : Tensor, %decoder_hidden.3 : Tensor = prim::TupleUnpack(%48)
          %decoder_scores.1 : Tensor, %decoder_input.3 : Tensor = aten::max(%decoder_output.1, %16, %53) # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/deploy_seq2seq_hybrid_frontend_tutorial.py:570:44
          %61 : Tensor[] = prim::ListConstruct(%all_tokens.6, %decoder_input.3)
          %all_tokens.3 : Tensor = aten::cat(%61, %26) # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/deploy_seq2seq_hybrid_frontend_tutorial.py:572:25
          %67 : Tensor[] = prim::ListConstruct(%all_scores.6, %decoder_scores.1)
          %all_scores.3 : Tensor = aten::cat(%67, %26) # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/deploy_seq2seq_hybrid_frontend_tutorial.py:573:25
          %decoder_input.7 : Tensor = aten::unsqueeze(%decoder_input.3, %26) # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/deploy_seq2seq_hybrid_frontend_tutorial.py:575:28
          -> (%42, %all_tokens.3, %all_scores.3, %decoder_hidden.3, %decoder_input.7)
