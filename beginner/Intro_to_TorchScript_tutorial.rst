...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    (tensor([[0.6475, 0.5528, 0.6704, 0.7645],
            [0.5550, 0.8042, 0.7031, 0.9115],
            [0.8567, 0.8573, 0.3531, 0.6721]]), tensor([[0.6475, 0.5528, 0.6704, 0.7645],
            [0.5550, 0.8042, 0.7031, 0.9115],
            [0.8567, 0.8573, 0.3531, 0.6721]]))
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    (tensor([[ 0.6410,  0.6691,  0.0640,  0.6950],
            [ 0.7906,  0.4525, -0.2827,  0.4677],
            [ 0.9168,  0.8085, -0.2076,  0.2824]], grad_fn=<TanhBackward>), tensor([[ 0.6410,  0.6691,  0.0640,  0.6950],
            [ 0.7906,  0.4525, -0.2827,  0.4677],
            [ 0.9168,  0.8085, -0.2076,  0.2824]], grad_fn=<TanhBackward>))
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    (tensor([[0.2264, 0.5256, 0.6205, 0.5346],
            [0.7090, 0.2887, 0.0348, 0.9279],
            [0.8096, 0.7650, 0.3442, 0.5109]], grad_fn=<TanhBackward>), tensor([[0.2264, 0.5256, 0.6205, 0.5346],
            [0.7090, 0.2887, 0.0348, 0.9279],
            [0.8096, 0.7650, 0.3442, 0.5109]], grad_fn=<TanhBackward>))
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    graph(%self.1 : __torch__.MyCell,
      ...
      %14 : int = prim::Constant[value=1]() # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/Intro_to_TorchScript_tutorial.py:188:0
      %15 : Float(3, 4, strides=[4, 1], requires_grad=1, device=cpu) = aten::add(%23, %h, %14) # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/Intro_to_TorchScript_tutorial.py:188:0
      %16 : Float(3, 4, strides=[4, 1], requires_grad=1, device=cpu) = aten::tanh(%15) # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/Intro_to_TorchScript_tutorial.py:188:0
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    (tensor([[0.5175, 0.7063, 0.3240, 0.9168],
            [0.4317, 0.6472, 0.3432, 0.7272],
            [0.7614, 0.6960, 0.1853, 0.7272]], grad_fn=<TanhBackward>), tensor([[0.5175, 0.7063, 0.3240, 0.9168],
            [0.4317, 0.6472, 0.3432, 0.7272],
            [0.7614, 0.6960, 0.1853, 0.7272]], grad_fn=<TanhBackward>))
    (tensor([[0.5175, 0.7063, 0.3240, 0.9168],
            [0.4317, 0.6472, 0.3432, 0.7272],
            [0.7614, 0.6960, 0.1853, 0.7272]], grad_fn=<TanhBackward>), tensor([[0.5175, 0.7063, 0.3240, 0.9168],
            [0.4317, 0.6472, 0.3432, 0.7272],
