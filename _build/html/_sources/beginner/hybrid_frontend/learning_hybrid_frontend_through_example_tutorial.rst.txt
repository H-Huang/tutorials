...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    traced_fn graph graph(%x : Float(requires_grad=0, device=cpu)):
      %1 : Long(requires_grad=0, device=cpu) = prim::Constant[value={2}]() # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/hybrid_frontend/learning_hybrid_frontend_through_example_tutorial.py:105:0
      %2 : Float(requires_grad=0, device=cpu) = aten::mul(%x, %1) # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/hybrid_frontend/learning_hybrid_frontend_through_example_tutorial.py:105:0
      %3 : Float(requires_grad=0, device=cpu) = aten::abs(%2) # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/hybrid_frontend/learning_hybrid_frontend_through_example_tutorial.py:105:0
      return (%3)

    script_fn graph graph(%x.1 : Tensor):
      %13 : bool = prim::Constant[value=1]() # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/hybrid_frontend/learning_hybrid_frontend_through_example_tutorial.py:127:4
      %4 : None = prim::Constant()
      %3 : int = prim::Constant[value=4]() # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/hybrid_frontend/learning_hybrid_frontend_through_example_tutorial.py:126:30
      %1 : int = prim::Constant[value=1]() # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/hybrid_frontend/learning_hybrid_frontend_through_example_tutorial.py:126:20
      %2 : int[] = prim::ListConstruct(%1)
      %z.1 : Tensor = aten::ones(%2, %3, %4, %4, %4) # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/hybrid_frontend/learning_hybrid_frontend_through_example_tutorial.py:126:8
      %10 : int = aten::Int(%x.1) # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/hybrid_frontend/learning_hybrid_frontend_through_example_tutorial.py:127:19
      %z : Tensor = prim::Loop(%10, %13, %z.1) # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/hybrid_frontend/learning_hybrid_frontend_through_example_tutorial.py:127:4
        block0(%i.1 : int, %z.6 : Tensor):
          %17 : int = aten::add(%i.1, %1) # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/hybrid_frontend/learning_hybrid_frontend_through_example_tutorial.py:128:17
          %z.3 : Tensor = aten::mul(%z.6, %17) # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/hybrid_frontend/learning_hybrid_frontend_through_example_tutorial.py:128:12
          -> (%13, %z.3)
      return (%z)

    TracedModule graph graph(%self : __torch__.TracedModule,
          %x.1 : Float(requires_grad=0, device=cpu)):
      %4 : Device = prim::Constant[value="cpu"]() # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/hybrid_frontend/learning_hybrid_frontend_through_example_tutorial.py:145:0
      %5 : int = prim::Constant[value=6]() # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/hybrid_frontend/learning_hybrid_frontend_through_example_tutorial.py:145:0
      %6 : bool = prim::Constant[value=0]() # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/hybrid_frontend/learning_hybrid_frontend_through_example_tutorial.py:145:0
      %7 : bool = prim::Constant[value=0]() # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/hybrid_frontend/learning_hybrid_frontend_through_example_tutorial.py:145:0
      %8 : None = prim::Constant()
      %x : Float(requires_grad=0, device=cpu) = aten::to(%x.1, %4, %5, %6, %7, %8) # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/hybrid_frontend/learning_hybrid_frontend_through_example_tutorial.py:145:0
      %10 : Float(requires_grad=0, device=cpu) = aten::sqrt(%x) # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/hybrid_frontend/learning_hybrid_frontend_through_example_tutorial.py:146:0
      %11 : Double(requires_grad=0, device=cpu) = prim::Constant[value={5}]() # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/hybrid_frontend/learning_hybrid_frontend_through_example_tutorial.py:146:0
      %12 : Float(requires_grad=0, device=cpu) = aten::div(%10, %11) # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/hybrid_frontend/learning_hybrid_frontend_through_example_tutorial.py:146:0
      %13 : Float(requires_grad=0, device=cpu) = aten::floor(%12) # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/hybrid_frontend/learning_hybrid_frontend_through_example_tutorial.py:146:0
      return (%13)

    ScriptModule graph graph(%self : __torch__.ScriptModule,
          %x.1 : Tensor):
      %5 : float = prim::Constant[value=2.]() # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/hybrid_frontend/learning_hybrid_frontend_through_example_tutorial.py:166:29
      %9 : float = prim::Constant[value=0.]() # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/hybrid_frontend/learning_hybrid_frontend_through_example_tutorial.py:166:38
      %r.1 : Tensor = aten::neg(%x.1) # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/hybrid_frontend/learning_hybrid_frontend_through_example_tutorial.py:165:12
      %6 : Tensor = aten::fmod(%x.1, %5) # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/hybrid_frontend/learning_hybrid_frontend_through_example_tutorial.py:166:15
      %8 : int = aten::Int(%6) # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/hybrid_frontend/learning_hybrid_frontend_through_example_tutorial.py:166:11
      %10 : bool = aten::eq(%8, %9) # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/hybrid_frontend/learning_hybrid_frontend_through_example_tutorial.py:166:11
      %r : Tensor = prim::If(%10) # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/hybrid_frontend/learning_hybrid_frontend_through_example_tutorial.py:166:8
        block0():
          %r.2 : Tensor = aten::div(%x.1, %5) # /private/home/howardhuang/pytorch-projects/tutorials/beginner_source/hybrid_frontend/learning_hybrid_frontend_through_example_tutorial.py:167:16
          -> (%r.2)
        block1():
          -> (%r.1)
      return (%r)
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    n_traced graph graph(%self : __torch__.Net,
      ...
      %17 : __torch__.ScriptModule = prim::GetAttr[name="script_module"](%self)
      %16 : __torch__.TracedModule = prim::GetAttr[name="traced_module"](%self)
      %10 : Function = prim::Constant[name="fn"]()
      %x : Tensor = prim::CallFunction(%10, %x.1)
      %12 : Function = prim::Constant[name="script_fn"]()
      %13 : Tensor = prim::CallFunction(%12, %x)
      %14 : Tensor = prim::CallMethod[name="forward"](%16, %13)
      %15 : Tensor = prim::CallMethod[name="forward"](%17, %14)
      return (%15)
