.. note::
    ...
    Click :ref:`here <sphx_glr_download_beginner_vt_tutorial.py>` to download the full example code
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** ( 0 minutes  35.850 seconds)
